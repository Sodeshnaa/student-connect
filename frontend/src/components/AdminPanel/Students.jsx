...
function Students() {
    const dummyStudents = [
        { id: 1, name: 'John Doe', email: 'john@gncasc.org', graduationYear: 2024 },
        { id: 2, name: 'Jane Smith', email: 'jane@gncasc.org', graduationYear: 2023 },
        { id: 3, name: 'Alice Johnson', email: 'alice@gncasc.org', graduationYear: 2022 },
    ];
